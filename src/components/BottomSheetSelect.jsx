  ...
  return (
    <>
      <button
        ...
        className={`tap-target inline-flex items-center justify-between gap-2 px-3 rounded-lg border border-border bg-white text-sm hover:bg-foreground/[0.02] ${className}`}
      >
