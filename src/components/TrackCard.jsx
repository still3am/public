    ...
    >
      <div className="relative aspect-square rounded-xl overflow-hidden bg-foreground/[0.06] mb-2.5 shadow-sm">
        ...
        <div className="absolute top-2 left-2 flex items-center gap-1">
          ...
          {isRecent && (
            <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full bg-background/85 backdrop-blur text-foreground text-[9px] font-bold tracking-wide">
              <Clock size={9} /> NEW
            </span>
          )}
        </div>
