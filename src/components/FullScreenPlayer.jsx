  ...
  return (
    <div
      ...
      <div className="relative flex-1 flex flex-col xl:flex-row min-h-0 gap-4 xl:gap-16 xl:px-16 2xl:px-24 xl:pb-8">
        ...
        {/* RIGHT (desktop): lyrics panel — only when the track actually has lyrics */}
        <div className={`${showLyricsPanel && hasLyrics ? "hidden xl:flex" : "hidden"} flex-col min-h-0 w-[440px] 2xl:w-[480px] shrink-0 bg-white/[0.06] ring-1 ring-white/10 rounded-[2rem] overflow-hidden`}>
