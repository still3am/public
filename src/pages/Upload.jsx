      ...
      <div className="max-w-3xl mx-auto">
        ...
        {mode === "choose" && (
          <>
            ...
            />
            <div className="mt-6 p-4 rounded-2xl border border-border bg-foreground/[0.02] text-xs text-foreground/50">
        ...
        {mode === "single" && (
          <SingleEditor
            ...
            progress={progress}
            onPickFile={(files) => {
              if (files && files.length) onFilesSelected(files, false);
              else singleInputRef.current?.click();
            }}
