            ...
            <div className="max-w-md w-full">
                <div className="text-center space-y-6">
                    ...
                    {isFetched && authData.isAuthenticated && authData.user?.role === 'admin' && (
                        <div className="mt-8 p-4 bg-foreground/[0.04] rounded-lg border border-border">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-lg hover:bg-foreground/5 hover:border-foreground/30 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
                        >
